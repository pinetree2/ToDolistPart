...
public class ToDoListCheckController {
    ...
    public static void ToDoListCheckController(int Main_Index, int Sub_index,int Chatindex,boolean Check) throws IOException {
